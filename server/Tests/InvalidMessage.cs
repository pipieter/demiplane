...
public class InvalidMessageTests : ServerTestSetup
{
    ...
    [
        "{'type': 'request_create', 'create': {'type': 'circle', 'id': '123', 'color': '#FF0000', 'x': 200, 'h': 200}}",
        "{'type': 'request_delete'}",
    ];

    private static readonly string[] InvalidFieldMessages =
    [
        "{'type': 'request_create', 'create': {'type': 'circle', 'id': '123', 'color': '#FF0000', 'x': 'x-value', 'y': 'y-value', 'w': 200, 'h': 200}}",
